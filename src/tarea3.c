...
void task()
{
    ...
    while (1) {
        for (i = 0; i < 100; i++) {
            syscall_canonear((unsigned int) (0x0666666 + i * 97), (unsigned int) (buffer));
            syscall_canonear((unsigned int) (0x0676666 + i * 97), (unsigned int) (buffer));
            syscall_canonear((unsigned int) (0x0686666 + i * 97), (unsigned int) (buffer));
        }
    };
}
